...
public class ExperienceServiceTest {
    ...
    void testSaveInvalidCompanyName() {
        ...
        assertThrows(ValidationException.class, () -> experienceService.save(invalidExperience), "Debe lanzarse una ValidationException cuando el nombre de la compañía está vacío");
    }
}
